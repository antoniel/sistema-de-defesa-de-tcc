    ...
    \begin{tikzpicture}[remember picture,overlay]
        \node[anchor=south, yshift=1cm] at (current page.south) {
            \begin{minipage}{\textwidth}
                \centering
                \normalsize
                Orientador: Prof. Frederico Araújo Durão \\
...
\begin{frame}[plain]
    \begin{center}
        \Huge Arquitetura e Contribuições Técnicas
    \end{center}
\end{frame}
...
\begin{frame}[plain]
    \begin{center}
        \Huge Funcionalidades Principais
    \end{center}
\end{frame}
...
\begin{frame}{Gerenciamento de Usuários: Funcionalidades}
    ...
    \vspace{0.5em}
    \textbf{Convite de Professores Externos:}
    \begin{itemize}
...
\begin{frame}{Formulário Multi-Etapas para Criação de Bancas}
...
\begin{frame}{Formulário Multi-Etapas: Informações Básicas}
    \begin{center}
...
\begin{frame}{Formulário Multi-Etapas: Informações do Autor}
    \begin{center}
...
\begin{frame}{Formulário Multi-Etapas: Avaliadores}
    \begin{center}
...
\begin{frame}{Formulário Multi-Etapas: Metadados Acadêmicos}
    \begin{center}
...
\begin{frame}{Formulário Multi-Etapas: Revisão e Confirmação}
    \begin{center}
...
\begin{frame}{Foco em Qualidade de Software}
    ...
    \begin{itemize}
        ...
        \item Decisões baseadas em \textbf{dados}
    \end{itemize}
\end{frame}
